...
Revision ID: 3d684df4bd89
Revises: a16a146a5511
Create Date: 2025-09-29 11:18:55.545809
...
revision = '3d684df4bd89'
down_revision = 'a16a146a5511'
branch_labels = None
depends_on = None
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('user', schema=None) as batch_op:
        batch_op.add_column(sa.Column('profile_image', sa.VARCHAR(length=120), nullable=True))
